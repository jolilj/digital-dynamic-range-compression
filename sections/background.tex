...
In \cite{frindle1996implementation} a  feed-forward design with static behaviour as in previous work, but with different dynamic characteristics, is presented. Here an integrator filter is applied in the log domain resulting in a linear attack and release phase. Furthermore a hold parameter is introduced delaying the release phase. To smooth out the decay, the release rate is progressively increased until the defined release rate is reached. This characteristic is illustrated in Fig \ref{fig:findle_dynamics}
%============================
\begin{figure}
\centerline{
