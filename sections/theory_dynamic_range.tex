...
For a periodic signal, the \emph{peak amplitude} can be unambiguously defined as the maximum absolute value over the signal's period. For a signal $x(t)$ with period $T$ the peak amplitude is thus defined as
%================================
\begin{equation}
...
To distinguish between linear and logarithmic quantities the former are denoted by lowercase and the latter by uppercase letters.
%================================
