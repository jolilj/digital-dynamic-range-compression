...
\item{Time Dependent}
 \begin{itemize}
\item \textbf{Attack time} $\tau_{att}$ - Determines how quickly the compression ratio is applied.
\item \textbf{Release time} $\tau_{rel}$ - Determines how quickly the compression is released as the input signal drops below the threshold level.
...
The time dependent characteristics are depicted in Fig ~\ref{fig:typical_envelope_detailed}
%================================
\begin{figure}
