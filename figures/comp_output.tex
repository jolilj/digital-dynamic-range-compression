...
% vertical axis
\draw[->] (0,-3) -- (0,3) node[yshift=1.2em,anchor=north] {\scriptsize Signal};
%GRAPH
%input
...
%Input
\draw[samples=1000,domain=0.4:2.501] plot(\x,{(0.6+0.4*exp(-(\x-0.4)/0.25))*(2.5*sin(deg(2*pi*5*(\x))))});

\draw[samples=1000,domain=2.5:5] plot(\x,{(1-0.6*exp(-(\x-2.5)/0.3))*sin(deg(2*pi*5*(\x)))});
