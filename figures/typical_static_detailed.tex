L\documentclass[../main2.tex]{subfiles}
...
% AXES
% horizontal axis
\draw[->] (0,0) -- (10,0) node[anchor=north] {\scriptsize$L$};
% vertical axis
\draw[->] (0,0) -- (0,7) node[anchor=east] {\scriptsize$Y(L)$};
...
%Ratio
\draw(9.2,5.2) node{{$\frac{dY}{dL} = \frac{1}{R}$}};
