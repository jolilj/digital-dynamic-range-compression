...
(path picture bounding box.center) -- (path picture bounding box.north west) (path picture bounding box.center) -- (path picture bounding box.north east);
	...
	\matrix (m1) [row sep=2.5mm, column sep=5mm]
	{
		...
		\node[coordinate]                  (m21) {};          &
		\node[coordinate]                  (m22) {};          &
		\node[dspfilter, minimum size = 10mm] (m23) {abs};          &
		\node[dspfilter, minimum size = 10mm]                  (m24) {dB};          &
		\node[dspfilter,minimum width = 18mm,text height=2em] (m25) {\small Gain \\ \small computer};          &
		\node[dspfilter,minimum width = 18mm,text height=2em] (m26) {\small Gain \\ \small smoothing };          &
		\node[dspadder]                  (m27) {};          &
		\node[dspfilter, minimum size = 10mm]                  (m28) {lin};          &
		\node[coordinate]                  (m29) {};          &
		\node[coordinate]                  (m210) {};          &
		\node[coordinate]                  (m2X) {};          &  \\
		%--------------------------------------------------------------------
